...
# Computer Vision: CNN with Transfer Learning and Fine-Tuning for binary Classification
...
The goal of this project is to use a pre-trained convolutional neural network with Fine-Tuning and apply it to an existing classification problem.  
How I proceeded exactly and what results I achieved can be read in my blog post: [CV - CNN with TFL and Fine-Tuning](https://michael-fuchs-python.netlify.app/2021/01/22/cv-cnn-with-tfl-and-fine-tuning/)
...
5. Start the notebook ```CNN with TFL and Fine-Tuning.ipynb```.
...
```
C:.
│   CNN with TFL and Fine-Tuning.ipynb
...
│       Cats_Dogs_CNN_TFL_VGG19_FineTuning_epoch_30.h5
│       class_assignment_df_Cats_Dogs_CNN_TFL_VGG19_FineTuning_epoch_30.csv
│       history_df_Cats_Dogs_CNN_TFL_VGG19_FineTuning_epoch_30.csv
│       img_height.pkl
│       img_width.pkl
│
├───dogs
...
The best model achieved a validation accuracy of over 93%.
...
Here is the link to my blog post: [CV - CNN with TFL and Fine-Tuning](https://michael-fuchs-python.netlify.app/2021/01/22/cv-cnn-with-tfl-and-fine-tuning/).
